                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 my-auto">
                                            <label class="price">{{ $cartItem->product->selling_price }}đ </label>
                                        </div>
                                        ...
                                        <div class="col-md-2 my-auto">
                                            <label
                                                class="price">{{ $cartItem->product->selling_price * $cartItem->quantity }}đ
                                                @php $totalPrice += $cartItem->product->selling_price * $cartItem->quantity @endphp </label>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Tổng tiền
                            <span class="float-end">{{ $totalPrice }}đ</span>
                        </h4>
                        <hr>
