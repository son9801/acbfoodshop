...
class CheckoutShow extends Component
{
    ...
    //     $vnp_Returnurl = 'thank-you';
    //     $vnp_TmnCode = "3J27I0R6"; //Mã website tại VNPAY 
    //     $vnp_HashSecret = " ILLKBBNMGEVOMQHBJHMLSRXDSZEGBVMY"; //Chuỗi bí mật
    ...
    public function placeOrder()
    {
        ...
        $order = Order::create([
            ...
            'tracking_no' => 'acbfood-' . Str::random(10),
        ...
        foreach ($this->carts as $cartItem) {
            ...
            if ($availableQuantity >= $cartItem->quantity) {
                ...
                $this->dispatchBrowserEvent('message', [
                    'text' => 'Sản phẩm '.$cartItem->product->name.' chỉ còn ' . $availableQuantity,
                    'type' => 'error',
                    'status' => 500
                ]);
            }
    ...
    {
        $this->payment_mode = 'Thanh toán COD';
